...
export function Stats() {
  const stats: StatItem[] = [
    { value: 9400000, label: "Settlements Analyzed", suffix: "+" },
    { value: 7000, label: "Active Markets", suffix: "+" },
    { value: 5, label: "Exchanges Live" },
    { value: 0, label: "Cost — Always Free", prefix: "$" },
