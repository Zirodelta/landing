...
const footerLinks = {
  ...
  Resources: [
    ...
    { label: "Funding Rates", href: "https://settled.pro/rates" },
    { label: "Funding Intervals", href: "https://settled.pro/funding-intervals" },
    { label: "Learn", href: "https://learn.settled.pro" },
    { label: "API Docs", href: "https://docs.settled.pro" },
  ],
  Community: [
